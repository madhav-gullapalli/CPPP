...
template <typename A, typename B> class CPPPPair; template <typename T> class CPPPList; template <typename T> class CPPPHeap; template <typename T> class CPPPSet; template <typename K, typename V> class CPPPMap;
...
int main() {
    ...
    try {
    CPPPList<long long> L = CPPPInputList(4, [&]() { return CPPPInputInt(); });
    cout << CPPPListAt(L, f(0), 5, 8); cout << '\n';
    cout << CPPPListAt(L, f((-1)), 6, 8); cout << '\n';
    return 0;
